...
describe("Test delete a tag in Ghost", () => {
    ...
    it("Delete a tag", () => {
        ...
        cy.wait(2000);
        if(appVersion == "3.41.1") cy.get(".gh-list-row.gh-tags-list-item.ember-view").contains("Tag1").click();
        else cy.get(".gh-list-row.gh-tags-list-item").contains("Tag1").click();
        cy.wait(3000);
        cy.screenshot(`step_3/${appReference}-view-tag`);
        if(appVersion == "3.41.1") cy.get(".gh-btn.gh-btn-red.gh-btn-icon.mb15").click();
        else cy.get(".gh-btn.gh-btn-red.gh-btn-icon").click();
        cy.wait(2000);
